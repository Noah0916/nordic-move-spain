      ...
      <nav className="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-black/15 backdrop-blur-md">
        ...
        <div className="mx-auto hidden max-w-7xl items-center justify-between px-8 py-4 md:flex">
          ...
          <div className="flex gap-8 text-sm text-white">
            ...
            <a href="/regions" className="transition hover:text-white/70">
              Regions
            </a>
            ...
            <a href="/guides" className="transition hover:text-white/70">
              Guides
            </a>

            <a href="/about-us" className="transition hover:text-white/70">
              About us
            </a>
        ...
        <div className="md:hidden">
          ...
          >
            ...
            <a href="/regions" className="shrink-0 transition hover:text-white/70">
              Regions
            </a>

            <a href="/villas" className="shrink-0 transition hover:text-white/70">
              Villas
            </a>

            <a href="/services" className="shrink-0 transition hover:text-white/70">
              Services
            </a>

            <a href="/guides" className="shrink-0 transition hover:text-white/70">
              Guides
            </a>

            <a href="/about-us" className="shrink-0 transition hover:text-white/70">
              About us
            </a>

            <a href="/contact" className="shrink-0 transition hover:text-white/70">
              Contact
            </a>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-4xl">
              ...
              <p className="mt-6 max-w-3xl text-lg leading-relaxed text-stone-600">
                Nordic Move Spain is not tied to one agency or one portfolio. We work with
                multiple property professionals across the Costa Blanca North and search the
                wider market on behalf of our buyers.
              </p>
            </div>
          ...
          <div className="mt-9 flex flex-col gap-4 border-t border-stone-300/70 pt-7 md:flex-row md:items-center md:justify-between">
            <p className="max-w-4xl text-sm leading-relaxed text-stone-500">
              Property offered through one of our collaborating property partners. Nordic Move Spain
              represents and advises the buyer. Availability and property information can change.
            </p>
            <a href="/contact" className="text-sm font-medium text-[#1e2a3a] underline underline-offset-4">
              Looking for something different? Tell us what you need.
            </a>
          </div>
        </div>
      </section>
